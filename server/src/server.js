...
app.use(cors({
  origin: (origin, callback) => {
    // Permissive for Vercel deployments & preview URLs
    callback(null, true);
  },
  credentials: true
}));
...
// Ensure database connection on each request (Serverless safe)
...
// In case file is imported or run directly (Skip app.listen in Vercel Serverless environment)
