...
import { syncAllPendingPaymentLinks } from '../services/recoveryAgentService.js';
...
router.get('/stats', async (req, res) => {
  try {
    // Proactively sync all Razorpay payment links
    ...
    // If merchantId is provided and merchant has no products, check if store has any orders
    let orderQuery = {};
