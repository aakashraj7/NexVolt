...
export const Home: React.FC = () => {
  ...
  return (
    <div className="space-y-16 pb-20">
      ...
      <section className="relative overflow-hidden pt-6 pb-12 md:py-16 bg-slate-50 border-b border-slate-200/80">
        {/* Glow ambient lights */}
        <div className="absolute top-1/4 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[600px] h-[300px] bg-gradient-to-tr from-cyan-200/30 via-blue-200/20 to-purple-200/10 rounded-full blur-3xl pointer-events-none" />
      ...
      <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="rounded-3xl p-6 sm:p-8 bg-gradient-to-r from-amber-50/70 via-slate-50 to-blue-50/60 border border-slate-200/90 text-slate-900 relative overflow-hidden shadow-sm">
          <div className="flex flex-col md:flex-row md:items-center justify-between gap-6 mb-8">
            <div className="space-y-1">
              <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-amber-100/90 border border-amber-300/80 text-amber-800 text-xs font-bold uppercase tracking-wider">
                <Flame className="w-4 h-4 fill-amber-500 text-amber-500" /> Limited Time Flash Deals
              </div>
            ...
            <div className="flex items-center gap-3">
              <span className="text-xs text-slate-600 font-bold flex items-center gap-1.5">
                <Clock className="w-4 h-4 text-cyan-600" /> Ends In:
              </span>
              <div className="flex items-center gap-1.5 font-mono text-sm font-bold">
                <div className="px-3 py-2 rounded-xl bg-white border border-slate-200 shadow-xs text-slate-900 font-extrabold">
                ...
                <span className="text-slate-400 font-bold">:</span>
                <div className="px-3 py-2 rounded-xl bg-amber-50 border border-amber-200 shadow-xs text-amber-600 font-extrabold">
      ...
      <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between mb-8">
          <div>
            <div className="flex items-center gap-2 text-cyan-700 text-xs font-bold uppercase tracking-wider mb-1">
              <Layers className="w-3.5 h-3.5 text-cyan-600" /> High Performance
            </div>
            <h2 className="text-2xl sm:text-3xl font-bold text-slate-900 font-heading">
